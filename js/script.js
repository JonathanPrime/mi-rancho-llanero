...
window.onscroll = () => {
   ...
   if (window.scrollY > 0) {
      ...
      document.getElementById('img-logo').src = '../images/svg/logo-color.svg';
   } else {
      document.querySelector('.header').classList.remove('active');
      document.getElementById('img-logo').src = '../images/svg/logo-blanco.svg';
   }
}
...
sendOrderBtn.addEventListener("click", () => {
   ...
   if (name == null || tel == null || dir == null
      ...
      window.open('https://wa.me/573132286949?text=' + relmsg + "%0a"
         + "---------------------------------" + "%0a"
         + "       DATOS DEL PEDIDO          " + "%0a"
         + "---------------------------------" + "%0a"
         + carritoEnTexto + "%0a"
